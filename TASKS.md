...
- [ ] **16.19** Misc cleanup, bundle as one PR:
  - ~~`daemon/src/vad-bridge.ts:142-144` doesn't surface socket errors to caller — only logs. Add `errorHandlers` for transient socket errors so a host can backoff/alert.~~ (see #PR)
