...
- [x] **16.12** README has stale + broken sections.
  ...
  Either delete the stale sections or refresh them. Test: the existing `readme-consistency.test.mjs` canary should be extended to fail on broken relative links. (see #PR)
